...
| `orchestration` | core | stable | Native orchestration ledger for task, git snapshot, gate, and lifecycle management. |
...
| `docs/concepts/native-orchestration.md` | core | Native orchestration ledger (promoted to Stable). |
...
10. ✅ Native orchestration promotion to Stable
