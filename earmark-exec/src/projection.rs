...
mod tests {
    use super::*;
    use earmark_core::SystemDefinition;
    use std::collections::BTreeMap;
    ...
    fn custom_registry() -> StandingRegistry {
        use earmark_core::{ProtocolBinding, StandingDimensionDefinition, StandingTokenDefinition};
    ...
    fn test_visibility_false_beats_true() {
        let sys = SystemDefinition {
            ...
            standing_dimensions: vec![
                earmark_core::StandingDimensionDefinition {
                    id: DimensionId::from_static("dim:a"),
                    default: TokenId::from_static("visible"),
                    tokens: vec![earmark_core::StandingTokenDefinition {
                        id: TokenId::from_static("visible"),
                        implements: vec![earmark_core::ProtocolBinding {
                            protocol: KernelProtocolId::from_static("kernel:visibility"),
                            state: None,
                            properties: BTreeMap::from([
                                (
